    ...
    <div className="flex justify-between bg-white" >
      <div>
        ...
        <nav className={`${
          ...
          } md:flex-col md:text-xl md:font-medium md:h-screen md:flex md:w-1/5 md:justify-evenly md:items-center md:font-mono md:fixed md:z-10 md:bg-white md:shadow-2xl md: border-zinc-100`}>
