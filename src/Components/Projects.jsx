...
const Projects = () => {
 const projectList = projectData.map( (project) => {
  ...
  return (
  <div className="w-full shadow-xl rounded-lg p-4 mx-auto h-auto border-2 border-slate-100 lg:w-2/4 ">
    <div className="w-4/4">
    <img src={image} alt={name} className=" grayscale  contrast-100 border-2 border-black w-full mx-auto aspect-square  rounded-lg max-w-full lg:h-60"/>
    </div>
    <p className="text-xl tracking-wide leading-loose font-bold w-full">{name}</p>
  ...
  return (
    <div>
      ...
      <div className="mx-2 h-auto my-12 min-h-screen lg:flex lg:justify-center lg:mx-0 lg:gap-4" >
