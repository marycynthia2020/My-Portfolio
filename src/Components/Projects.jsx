...
const Projects = () => {
 ...
 const projectList = projectData.map( (project) => { /* function to map through the arrays of all the projects I have so far (projectDataO is the array of all the projects*/
